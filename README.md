...
This module is a collection of several plugins for the JAXB2 (Java API for XML binding) "XSD to Java Compiler" (XJC). These plugins are intended to add support for additional contracts to the classes generated by XJC. Currently, there are 5 plugin classes:

1. **group-contract**: When using `<attributeGroup>` or `<group>` elements in an XSD, they are transformed as interface definitions, and any complexTypes using the groups will be generated as classes implementing this interface.
...
Please refer to the [generated usage info][4].
...
Please refer to the [generated usage info][5].
...
Please refer to the [generated usage info][6].
...
Please refer to the [generated usage info][7].

##  immutable

###  Motivation

Contemporary programming styles include making objects immutable as much as possible, to minimise side effects and allow for functional programming patterns.
...
Please refer to the [generated usage info][8].
...
Please refer to the [generated usage info][9].
...
Please refer to the [generated usage info][10].

Jaxb2-rich-contract-plugin maintained by [mklemm][11]

Published with [GitHub Pages][12]

[1]: https://github.com/mklemm/jaxb2-rich-contract-plugin
[2]: https://github.com/mklemm/jaxb2-rich-contract-plugin/zipball/master
[3]: https://github.com/mklemm/jaxb2-rich-contract-plugin/tarball/master
[4]: http://mklemm.github.io/jaxb2-rich-contract-plugin/plugin-usage_en.xhtml#group-contract
[5]: http://mklemm.github.io/jaxb2-rich-contract-plugin/plugin-usage_en.xhtml#constrained-properties
[6]: http://mklemm.github.io/jaxb2-rich-contract-plugin/plugin-usage_en.xhtml#copy
[7]: http://mklemm.github.io/jaxb2-rich-contract-plugin/plugin-usage_en.xhtml#clone
[8]: http://mklemm.github.io/jaxb2-rich-contract-plugin/plugin-usage_en.xhtml#immutable
[9]: http://mklemm.github.io/jaxb2-rich-contract-plugin/plugin-usage_en.xhtml#fluent-builder
[10]: http://mklemm.github.io/jaxb2-rich-contract-plugin/plugin-usage_en.xhtml#meta
[11]: https://github.com/mklemm
